...
function updateAccountButton() {
    ...
    if (btn) {
      btn.innerHTML = '<img src="../public/icons/conta.png" height="25" width="25"> Minha Conta';
  ...
  document.addEventListener('DOMContentLoaded', function () {
    updateAccountButton();
    buscarDadosUsuario(); // <- não chame duas vezes
  });
  
  if (localStorage.getItem('token')) {
    updateAccountButton();
    buscarDadosUsuario(); // <- evite repetir aqui
  }
